import clerk,{ClerkExpressRequireSession} from '@clerk/clerk-sdk-node'; //changes ki hain yahan
...
export const initExpress = ({ app }) => {
	...
	//***********  below line is commented if any error occured in app then isko uncomment kr dena **************** */
	app.use(`${config.api.prefix}/users`,userRouter);

	app.use(ClerkExpressRequireSession()); // isme masla hai isko set krna hai
